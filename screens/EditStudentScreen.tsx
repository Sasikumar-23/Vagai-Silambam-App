...
import { User, Calendar, Camera, ArrowLeft, UserCircle2, Trash2 } from 'lucide-react-native';
...
export default function EditStudentScreen({ route, navigation }: any) {
  ...
  const handleUpdate = async () => {
    ...
    await storage.saveAllStudents(updatedStudents);
  ...
  return (
    ...
    >
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <Text style={styles.subtitle}>Modify the student details below. Changes will be reflected immediately in the system.</Text>
